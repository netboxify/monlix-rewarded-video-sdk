...
import com.netboxify.monlix_rewardedvideos_sdk.ui.AdFragment
...
class RewardedAdsBuilder {
    ...
    private val BASE_URL = "http://mediation.monlix.com/rewarded-video/item.xml"
    ...
    fun build(
        ...
        adConfigMap["apiendpoint"] = apiEndpoint //customAdConfiguration.apiEndpoint
...
//        }
    ...
    /** This will make sure you get a fragment for a valid ad, a null for an invalid ad */
    fun waitForFragment(timeoutMs: Long = 1000000): AdFragment? {
        ...
        Thread {
            ...
            if (builtAdFragment!!.adVast == "") {
                Log.e("MonlixAdSDK", "Unavailable Ad Network.")
                builtAdFragment?.activity?.supportFragmentManager?.beginTransaction()
                    ?.remove(builtAdFragment!!)
