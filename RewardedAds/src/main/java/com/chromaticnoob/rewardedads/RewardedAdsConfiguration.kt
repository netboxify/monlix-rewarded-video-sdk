...
import com.chromaticnoob.rewardedads.AdConstants.IMPRESSION_MODE_ON_FIRST_FRAME
...
class RewardedAdsConfiguration {
     ...
     */
    var impressionMode: Int = IMPRESSION_MODE_ON_FIRST_FRAME
        set(mode) {
     ...
     * @see [countDownTextSize]
     * @see [showCountdown]**/
    var countDownColor: Int = Color.WHITE
     ...
     * @see [showCountdown]
     */
    var countDownTextCaption = "The Rewarded Ad will close within:"
    ...
    var countDownTextSize: Float = 14f
        set(size) {
            field = if (size>0f) size else countDownTextSize
        }
     ...
     * which means it is visible unless you specify otherwise.
     */
    var exitButton = true
